  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-[var(--ring)] focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        success: "border-transparent bg-[var(--success)] text-[var(--success-foreground)] shadow",
        warning: "border-transparent bg-[var(--warning)] text-[var(--warning-foreground)] shadow",
      },
    },
    defaultVariants: {
      variant: "default",
